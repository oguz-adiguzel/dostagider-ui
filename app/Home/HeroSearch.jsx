...
const HeroSearch = () => {
  ...
  return (
    <div className="w-full h-[400px] lg:h-[700px] bg-[#EEF1FB] flex flex-col items-center relative z-20 px-2 lg:px-0">
      <p className="text-center pt-10 lg:pt-28 text-sm font-semibold">
        Yakınınızdaki satılık ve kiralık araçları bulun
      </p>
      <p className="text-center text-3xl lg:text-5xl font-sans font-light mt-4 text-[#050B20]">
      ...
      <div className="w-full lg:w-[960px] h-32 py-2 lg:py-0 lg:h-[75px] mx-auto mt-10 bg-white rounded-4xl lg:rounded-full flex flex-col justify-center lg:grid lg:grid-cols-12 px-3 shadow-2xl">
        <div className="col-span-11 h-full grid grid-cols-4">
          <div className="h-full flex items-center">
            <FormControl fullWidth>
              <InputLabel id="demo-simple-select-label">Araç Tipi</InputLabel>
              <Select
        ...
        <div className="lg:col-span-1 h-full flex items-end lg:items-center justify-end">
          <button
            onClick={() => getFiltersPage()}
            className=" w-full lg:w-14 h-10 lg:h-14 bg-orange-400 rounded-full flex items-center justify-center cursor-pointer hover:bg-orange-500 duration-200 shadow-md"
          >
      ...
      <div className="flex justify-center">
        ...
        <div
          ref={headlightRef}
          className="absolute bottom-36 left-52 w-[400px] h-[25px] rounded-full pointer-events-none z-50 hidden lg:block"
          style={{
            background:
