...
const Header = () => {
  ...
  return (
    <>
      {/* <ToastContainer /> */}
      <div className="w-full py-6 flex justify-between px-20">
        ...
        <li className="list-none flex items-center space-x-7 text-sm text-gray-700">
          ...
          <ul className="cursor-pointer hover:text-orange-400">Araç Sat</ul>
          <ul className="cursor-pointer hover:text-orange-400">
        ...
        <div className="flex items-center">
          {user ? (
            ...
            <a
              href="/login"
              className="flex items-center space-x-1 cursor-pointer hover:text-orange-500 duration-200"
            >
          ...
          <button className="ml-6 px-3 py-2 bg-orange-400 text-white text-sm cursor-pointer hover:rounded-full">
            Ücretsiz İlan Ver
          </button>
        </div>
      </div>
