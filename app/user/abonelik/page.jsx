...
const page = () => {
  ...
  const renewListing = async () => {
    try {
      ...
      setLoading(true);
      const response = await api.put(`/corporate/payment`, {
        slug: user.slug,
      });
      setLoading(false);
      ...
      content: (
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800">
            Kurumsal Üyeliğinizin Aktif Edilmesi İçin Abone Olunuz
          </h2>

          {/* Açıklama */}
          <p className="text-gray-600">
            Dostagider.com kurumsal müşteri sistemine hoşgeldiniz. Üyeliğinizin
            aktif edilebilmesi için kart bilgileriniz ile abone olmanız
            gerekmektedir. Abonelik işleminin ardından admin onayından sonra
            ilanlarınızı yayınlamaya başlayarak galerinizi dijitale
            taşıyabilirsiniz. Dostagider.com hayırlı müşteriler diler.
          </p>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full justify-center px-5">
            {pack?.map((pkg) => (
              <div
                key={pkg.name}
            ...
            <div className="col-span-2">
              <div className="border border-gray-400 p-5 w-full rounded-2xl">
                ...
                <div className="flex space-x-8 mt-6">
                  <div className="w-40 h-40 border border-gray-300 rounded-md">
                    <img
                  ...
                  <div className="flex flex-col">
                    <p className="font-semibold">{user?.galeriAdi}</p>
                    <div className="w-full flex space-x-16">
                      <div className="flex flex-col">
                        ...
                        <p className="text-sm">
                          {user?.yetkiliAdi}
                          <span className="ml-1">{user?.yetkiliSoyadi}</span>
                        </p>
